%define rubymajorver         2.3
%define rubyminorver         4
%define rubyver         %{rubymajorver}.%{rubyminorver}
...
Source0:        https://cache.ruby-lang.org/pub/ruby/%{rubymajorver}/ruby-%{rubyver}.tar.gz
...
%changelog
* Mon May 22 2017 Ronald Tse <ronald.tse@ribose.com> - 2.3.4-1
