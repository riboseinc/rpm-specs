...
%if 0%{?suse_version} >= 10 || 0%{?fedora} >= 24
Suggests: rubypick
...
# TODO: Disable checks for now 50 tests fail in a docker container, mainly due
# to dtrace, local address binding not working properly inside a container.
